const Caritems=(props)=>
{
    ...
    return(
<div className={a}>
            <p className="test_pic pt-3"><i className={props.smile}></i></p>
            ...
            <span className="pt-2 star"><i className="fa-sharp fa-solid fa-star"></i><i className="fa-sharp fa-solid fa-star"></i><i className="fa-sharp fa-solid fa-star"></i><i className="fa-regular fa-star"></i><i className="fa-regular fa-star"></i></span>
